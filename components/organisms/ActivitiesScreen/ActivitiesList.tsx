...
import ActivityCard, { DonationActivity } from '../../molecules/ActivitiesScreen/ActivityCard';
...
export default function ActivitiesList({ activities, onViewDetails }: ActivitiesListProps) {
