    ...
    try {
      if (user) {
        setUserData({
          ...
          imageUri: user.picture || "https://ui-avatars.com/api/?name=" + encodeURIComponent(getFullName()) + "&background=FF4757&color=fff&size=160",
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.profileHeader}>
              <TouchableOpacity onPress={handleProfilePicturePress}>
                <View style={styles.profileImageContainer}>
                  ...
                  />
                  <View style={[styles.badgeContainer, { backgroundColor: getBadgeColor(userData.donationBadge) }]}>
                    <Ionicons name={getBadgeIcon(userData.donationBadge)} size={16} color="white" />
                  </View>
                </View>
              </TouchableOpacity>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.quickActionsContainer}>
            <TouchableOpacity style={styles.quickActionCard} onPress={handleMyDonations}>
              <View style={styles.quickActionIcon}>
                <Ionicons name="heart" size={24} color="#FF4757" />
              </View>
              <Text style={styles.quickActionText}>{t('profile.my_donations')}</Text>
            </TouchableOpacity>
            
            <TouchableOpacity style={styles.quickActionCard} onPress={handleDonationEligibility}>
              <View style={styles.quickActionIcon}>
                <Ionicons name="checkmark-circle" size={24} color="#FF4757" />
              </View>
              <Text style={styles.quickActionText}>{t('profile.donation_eligibility')}</Text>
            </TouchableOpacity>
            
            <TouchableOpacity style={styles.quickActionCard} onPress={handleUpcomingAppointment}>
              <View style={styles.quickActionIcon}>
                <Ionicons name="calendar" size={24} color="#FF4757" />
              </View>
              <Text style={styles.quickActionText}>{t('profile.upcoming_appointment')}</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Text style={styles.sectionSubtitle}>{t('profile.app_preferences')}</Text>
          </View>
          
          <View style={styles.settingsCard}>
            <TouchableOpacity style={styles.settingItem} onPress={handleLanguage}>
              <View style={styles.settingLeft}>
                <Ionicons name="language" size={20} color="#FF4757" />
            ...
            <TouchableOpacity style={styles.settingItem} onPress={handleBecomeCampOrganizer}>
              <View style={styles.settingLeft}>
                <Ionicons name="business" size={20} color="#FF4757" />
                <Text style={styles.settingText}>{t('profile.become_camp_organizer')}</Text>
              </View>
              <Ionicons name="chevron-forward" size={20} color="#7F8C8D" />
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.settingsCard}>
            ...
            <TouchableOpacity style={styles.settingItem} onPress={handleLogOut}>
              <View style={styles.settingLeft}>
                ...
                <Text style={[styles.settingText, { color: '#FF4757' }]}>Log Out</Text>
              </View>
              <Ionicons name="chevron-forward" size={20} color="#7F8C8D" />
            </TouchableOpacity>
          </View>
