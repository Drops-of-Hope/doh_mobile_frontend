  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      message:
        "City General Hospital needs O+ blood donors urgently. 2 hours remaining.",
      timestamp: "2 min ago",
      isRead: false,
      priority: "high",
      actionRequired: true,
    },
    {
      ...
      message:
        "Your blood donation appointment is scheduled for tomorrow at 10:00 AM.",
    ...
    },
    {
      ...
      message:
        "Congratulations! You have completed 12 donations and earned Silver Donor status.",
      timestamp: "1 day ago",
      isRead: true,
      priority: "low",
    },
    ...
    },
    {
      ...
      message:
        "Thank you! The emergency request at Negombo General Hospital has been fulfilled.",
